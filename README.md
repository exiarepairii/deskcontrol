...
- Phone acts as touchpad (relative move, click, drag) and text input.
- Cursor overlay rendered on the external display.
...
5. Open **Touchpad** to move the cursor, click, drag, and send text input.
6. Open **Diagnostics** to review display info and recent failures.
7. Use **Stop Session** to clear session state and remove overlay.
...
- `TouchpadActivity`: touchpad UI (move, click, drag).
